...
<script>
    $.ajax({
        url: 'https://grammermx.com/RH/CargasGrammovilApp/dao/consultaCajaAhorro.php', // Reemplaza esto con la URL de tus datos
        dataType: 'json',
